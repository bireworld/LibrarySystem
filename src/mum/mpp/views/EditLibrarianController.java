...
public class EditLibrarianController {
	...
	private ObservableList<EditLibrarianSearchBean> searchResult;// = FXCollections.observableArrayList();
	...
	private void initTableView() {
		...
		tcolFirstName.setOnEditCommit(new EventHandler<CellEditEvent>() {
			...
			public void handle(CellEditEvent e) {
				((EditLibrarianSearchBean)e.getTableView().getItems()
	...
	public void btnSaveEdit_click() {
		...
		while(iterator.hasNext()) {
			...
			iterator.remove();
			//Librarian l = adminInterface.editLibrarian((Librarian)searchResultList.get(pos));
			//if(l!=null) 
				editCount++;
		}
